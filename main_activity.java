...
TextView xCoor; // deklarasikan A axis object
TextView yCoor; // deklarasikan B axis object
TextView zCoor; // deklarasikan C axis object
...
xCoor=(TextView)findViewById(R.id.xcoor); // buat A axis object
yCoor=(TextView)findViewById(R.id.ycoor); // buat B axis object
zCoor=(TextView)findViewById(R.id.zcoor); // buat C axis object
